...
---@field id number
---@field name string
---@field supports_method fun(method: string, opts?: {bufnr?: number}): boolean
---@field attached_buffers table<number, boolean>

---@class lspconfig.Config
---@field enabled boolean
---@field document_config {on_new_config: fun(config: lspconfig.Config, root_dir: string)}
...
---@alias lsp.Handler fun(err: any, result: any, ctx: any)
...
function M.disable(server, cond)
  ...
  if not def or not def.document_config then
    return
  end
...
---@field sources fun(buf: number): string[]
