...
description: >
  ...
  delete", "is this over-engineered", "simplify review", "ponytail-review", or
  invokes /ponytail-review. Complements correctness-focused review: this one
  only hunts complexity.
license: MIT
metadata:
  source: "https://github.com/DietrichGebert/ponytail/tree/14a0d79548d4de8fc2de95c1b94bb0de63a739d3/skills/ponytail-review"
...
Does not apply the fixes, only lists them. `stop ponytail-review` or
`normal mode`: revert to verbose review style.

## Source

Adapted from Dietrich Gebert's MIT-licensed Ponytail project:
`DietrichGebert/ponytail` → `skills/ponytail-review/SKILL.md` at commit
`14a0d79548d4de8fc2de95c1b94bb0de63a739d3`. License text is included in
`../ponytail/LICENSE`. Compare/update with:

```bash
gh api repos/DietrichGebert/ponytail/contents/skills/ponytail-review/SKILL.md --jq .content | base64 --decode
```
